...
import com.biz.bbs.persistance.BBsDao;
...
public class BBsApiController {
	...
	public BBsVO findById(@PathVariable("id") String id) {
	 ...
	 * VO에 데이터를 받을 수 있도록 처리하여 보내준다.
	 * 
	 * axios, fetch를 사용할때는 spring framework와의 관계에서
	 * 매끄럽지 못하게 데이터가 변환되는 현상이 있다.
	 * 
	 * 이 때는 VO클래스 앞에 @RequestBody를 붙여준다.
	 */
